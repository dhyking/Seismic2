...
public class TaskInfoModel extends CreatorInfoModel{
    ...
    public TaskInfoModel(String ID, String EVENTHEADID, int TASKTYPE, String TASKDESC, String MODIFIEDID,
            String MODIFIER, String MODIFIEDTIME, int STATE, int ISTEAMTASK, String PUBLISHTIME) {
        this.ID = ID;
...
//            if("CREATORNAME".equals(cursor.getColumnName(i))) this.setCreatorName(cursor.getString(i));
//        }
//    }
